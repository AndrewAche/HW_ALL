# [Домашнее задание](https://github.com/netology-code/micros-homeworks/blob/main/11-microservices-03-approaches.md) к занятию  "Микросервисы: подходы" - `Ачеусов Андрей`
